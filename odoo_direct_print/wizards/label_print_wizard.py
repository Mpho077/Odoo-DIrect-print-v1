...
class DirectPrintLabelWizard(models.TransientModel):
    _name = 'odoo.odoo.direct.print.label.wizard'
    ...
    product_ids = fields.Many2many(
        'product.product',
        'odoo_direct_print_label_wiz_product_rel',
        string='Products',
    )
    product_tmpl_ids = fields.Many2many(
        'product.template',
        'odoo_direct_print_label_wiz_tmpl_rel',
    ...
    def action_print_labels(self):
        ...
        if report_action.get('type') == 'ir.actions.report':
            return {
                ...
                'tag': 'odoo_direct_print_label_browser',
                'params': {
